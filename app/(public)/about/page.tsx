    ...
    <main className="px-6 py-12 lg:px-12 xl:px-20">
      <section className="mx-auto max-w-5xl">
        ...
        <p className="mt-4 max-w-3xl text-lg text-base-content/75">
          ...
          This client-preview implementation is prepared for local SQLite
          development and Turso/Vercel deployment.
        </p>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-base-300 bg-base-100 p-6">
            ...
            <p className="mt-2 text-sm text-base-content/70">
              Residents submit requests online, pay the fee via official GCash/Maya QR and
              submit proof for manual verification, and download the verified PDF after
